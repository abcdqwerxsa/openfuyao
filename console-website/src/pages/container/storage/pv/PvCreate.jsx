  ...
  return (
    <div className="child_content">
      <BreadCrumbCom className="create_bread" items={[
        { title: '存储', link: `/${containerRouterPrefix}/storage/pv` },
        { title: '数据卷(PV)', link: `/${containerRouterPrefix}/storage/pv` },
        { title: '创建数据卷(PV)' },
      ]} />
      <ResourceCreate
        type="Pv"
        clusterScoped
        yamlExample={pvYamlExample}
        submitApi={addPvYamlData}
        jumpPath={`/${containerRouterPrefix}/storage/pv`}
      />
    </div>
  );
}
