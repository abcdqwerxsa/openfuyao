...
import { createStatefulSet } from '@/api/containerApi';
  ...
  return (
    <div className="child_content">
      <BreadCrumbCom className="create_bread" items={[
        ...
        { title: 'StatefulSet', link: `/${containerRouterPrefix}/workload/statefulSet` },
        { title: '创建' },
      ]} />
      <ResourceCreate
        type="StatefulSet"
        yamlExample={statefulSetYamlExample}
        submitApi={createStatefulSet}
        jumpPath={`/${containerRouterPrefix}/workload/statefulSet`}
      />
    </div>
  );
}