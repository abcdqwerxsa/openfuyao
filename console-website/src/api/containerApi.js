 ...
 * 增加podyaml
 */
export function createPod(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/pods`,
  });
 ...
 * 修改pod yMAL
 */
export function updatePod(namespace, podName, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/pods/${podName}`,
  });
...
// deployment
export function listDeployments(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createDeployment(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/deployments`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function updateDeployment(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/deployments/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// statefulSet
export function listStatefulSets(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createStatefulSet(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/statefulsets`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function updateStatefulSet(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/statefulsets/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// daemonSet
export function listDaemonSets(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createDaemonSet(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/daemonsets`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function updateDaemonSet(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().workloadUrl}${namespace ? `/namespaces/${namespace}` : ''}/daemonsets/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// job
export function listJobs(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function deleteJob(namespace, jobName) {
  ...
  return DELETE(url, { 'propagationPolicy': 'Background' }, { 'Content-Type': 'application/json' });
}

export function createJob(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().jobUrl}${namespace ? `/namespaces/${namespace}` : ''}/jobs`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function getJob(namespace, name) {
  const url = qs.stringifyUrl({
...
export function updateJob(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().jobUrl}${namespace ? `/namespaces/${namespace}` : ''}/jobs/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// CronJob
export function listCronJobs(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createCronJob(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().jobUrl}${namespace ? `/namespaces/${namespace}` : ''}/cronjobs`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function getCronJob(namespace, name) {
  const url = qs.stringifyUrl({
...
export function updateCronJob(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().jobUrl}${namespace ? `/namespaces/${namespace}` : ''}/cronjobs/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
export function updateNamespace(namespaceName, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}/namespaces/${namespaceName}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// 限制范围
export function listLimitRangeLists(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createLimitRange(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/limitranges`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
}
export function getLimitRange(namespace, name) {
  const url = qs.stringifyUrl({
...
export function updateLimitRange(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/limitranges/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
...
// 资源配额
export function listResourceQuota(namespace) {
  const url = qs.stringifyUrl(
    {
...
export function createResourceQuota(namespace, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/resourcequotas`,
  });
  return POST(url, data, { 'Content-Type': 'application/json' });
...
export function updateResourceQuota(namespace, name, data) {
  const url = qs.stringifyUrl({
    url: `${commonApiPrefix().podUrl}${namespace ? `/namespaces/${namespace}` : ''}/resourcequotas/${name}`,
  });
  return PUT(url, data, { 'Content-Type': 'application/json' });
 ...
 */
export function getHelmUpgradeYamlData(repo, chart, version) {
  // return GET()
  const url = qs.stringifyUrl({
